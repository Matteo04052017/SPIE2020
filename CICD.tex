...
\textcolor{red}{I'm not sure if you want to capitalise all the references to Helm and Hem Charts ?.}
...
\section{Conclusion}
All the decisions taken by the Systems Team try to follow some of the continuous integration suggestion from Martin Fowler’s paper. In particular:
\begin{itemize}
